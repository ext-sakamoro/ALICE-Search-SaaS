...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['10,000 documents', '1,000 queries/hr', 'Basic full-text search', 'Community support'] },
  { name: 'Pro', price: '$59/mo', features: ['1M documents', 'FM-Index compression', 'Faceted search & autocomplete', '30,000 queries/hr', 'Custom analyzers', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited documents', 'Unlimited queries', 'Multi-language', 'Custom ranking', 'SLA 99.99%', 'Dedicated support'] },
];
